...
namespace EnhancedTweaks
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            seedNumberFontSize = Config.Bind("Seed Number", "Seed number font size", 14.0f, "The point font size for the seed number relative to a 1080p resolution.");
            ...
            seedNumberColorAlpha = Config.Bind("Seed Number", "Alpha color component for seed number (0-255)", 127, new ConfigDescription("", new AcceptableValueRange<int>(0, 255)));
